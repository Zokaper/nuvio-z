...
internal val navigationSavedStateConfiguration = SavedStateConfiguration {
    serializersModule = SerializersModule {
        polymorphic(NavKey::class) {
            ...
            subclass(DownloadChooseSourcesRoute::class, DownloadChooseSourcesRoute.serializer())
 ...
 */
internal val PlaybackRouteDecisionSaver: Saver<PlaybackRouteDecision?, Any> = listSaver(
