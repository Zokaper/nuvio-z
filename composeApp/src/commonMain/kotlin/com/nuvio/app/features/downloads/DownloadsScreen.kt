 ...
 *
 * Retry backoffs are the one place the row has to re-render without any state change
 * behind it; a static "retrying in 15s" that never moves reads as a stuck download.
 */
@Composable
