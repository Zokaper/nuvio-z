...
actual object PlayerSettingsStorage {
    ...
    actual fun loadPlaybackMode(): String? {
        val defaults = NSUserDefaults.standardUserDefaults
        return defaults.stringForKey(ProfileScopedKey.of(playbackModeKey))
    }
    ...
    actual fun loadPlaybackAudioPreference(): String? =
        NSUserDefaults.standardUserDefaults.stringForKey(
            ProfileScopedKey.of(playbackAudioPreferenceKey),
        )

    actual fun savePlaybackAudioPreference(preference: String) {
        NSUserDefaults.standardUserDefaults.setObject(
            preference,
            forKey = ProfileScopedKey.of(playbackAudioPreferenceKey),
        )
    }

    actual fun loadPlaybackLanguageStrictness(): String? =
        NSUserDefaults.standardUserDefaults.stringForKey(
            ProfileScopedKey.of(playbackLanguageStrictnessKey),
        )

    actual fun savePlaybackLanguageStrictness(strictness: String) {
        NSUserDefaults.standardUserDefaults.setObject(
            strictness,
            forKey = ProfileScopedKey.of(playbackLanguageStrictnessKey),
        )
    }

    actual fun loadPlaybackQualityCeilingMbps(): Int? {
        val defaults = NSUserDefaults.standardUserDefaults
    ...
    actual fun savePlaybackQualityCeilingMbps(mbps: Int) {
        NSUserDefaults.standardUserDefaults.setInteger(
            mbps.toLong(),
            forKey = ProfileScopedKey.of(playbackQualityCeilingMbpsKey),
        )
    }
    ...
    actual fun saveShowAdvancedSettings(enabled: Boolean) {
        NSUserDefaults.standardUserDefaults.setBool(enabled, forKey = ProfileScopedKey.of(showAdvancedSettingsKey))
    }

    actual fun loadPlaybackMeteredCapHeight(): Int? {
        val defaults = NSUserDefaults.standardUserDefaults
    ...
    actual fun savePlaybackMeteredCapHeight(height: Int) {
        NSUserDefaults.standardUserDefaults.setInteger(height.toLong(), forKey = ProfileScopedKey.of(playbackMeteredCapHeightKey))
    }

    actual fun loadSetupWizardCompletedRevision(): Int? {
        val defaults = NSUserDefaults.standardUserDefaults
