...
actions, success state, exact confirmation, contextual recovery help and a matching visual reference.
The terminal scripts remain advanced fallbacks.
